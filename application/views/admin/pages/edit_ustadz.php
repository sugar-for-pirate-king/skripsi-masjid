                ...
                <div class="card card-transparent">
                  <div class="card-header">
                    <div class="card-title">
                      <h4>Ubah Daftar Ustadz</h4>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  <div class="card-block">
                  <form class="form-horizontal" method="post" action="<?php echo site_url('admin/ustadz/update'); ?>">
                    <input type="hidden" name="id_ustadz" value="<?php echo $data_artikel->id_ustadz; ?>">
                    ...
                    <div class="control-group">
                      <label class="control-label">Pendidikan</label>
                        <div class="controls">
                          <input type="text" name="pendidikan" class="form-control" value="<?php echo $data_artikel->pendidikan; ?>">
                        </div>
                    </div>
                    <br><br>
                    <div class="control-group">
