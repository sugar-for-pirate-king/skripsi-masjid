            ...
            <div class=" col-xlg-2 bg-white">
              <div class="col-md-12 m-b-10">
                <div class="card card-transparent">
                  ...
                  <form class="form-horizontal" method="post" action="<?php echo site_url('artikel/update'); ?>" enctype="multipart/form-data">
                  <input type="hidden" name="blog_id" value="<?php echo $data_artikel->id_artikel; ?>">
                    <div class="control-group">
                      <label class="control-label" for="inputJudul">Judul</label>
                      <div class="controls">
                        <input type="text" value="<?php echo $data_artikel->judul; ?>" name="jdl_art" required class="form-control" >
                      </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                      <label class="control-label" for="inputIsiResep">Isi</label>
                      <div class="controls">
                        <textarea rows="10" cols="60" class="span12" name="isi_art" required><?php echo $data_artikel->isi; ?></textarea>
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label" for="inputGambar">Gambar </label>
                      <div class="controls">
                        <input type="file" id="inputGambar" name="gbr_art">
                        <input type="hidden" name="old_image" value="<?php echo $data_artikel->gambar; ?>">
                      </div>
                      <br>
                    </div>
                    <div class="control-group">
                      <div class="controls">
                        ...
                        <a href="<?php echo site_url('admin/artikel'); ?>" class="btn btn-danger">Kembali</a>
                      </div>
                    </div>
                  </form>
                  <script type="text/javascript">
                  ...
                  {
                    var editor = CKEDITOR.replace( 'isi_art' ); 
