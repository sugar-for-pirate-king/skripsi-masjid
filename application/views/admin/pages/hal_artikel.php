                ...
                <div class="card card-transparent">
                  <div class="card-header">
                    ...
                    <div class="pull-right">
                    	<div class="col-xs-12">
                    		<a href="<?php echo site_url('artikel/tambah');?>" class="btn btn-complete btn-cons">Tambah Artikel</a>
                    	</div>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                    ...
                    <table class="table demo-table-search table-responsive-block" id="tableWithSearch">
                    	...
                    	<tbody>
                          ...
                          <td><?php echo $value->tanggal ?></td>
                    			<td>
                            <div class="btn-group">
                    				<a href="<?php echo site_url('artikel/lihat/'.$value->id_artikel); ?>" class="btn btn-primary btn-xs">Lihat</a>
                    				<a href="<?php echo site_url('artikel/ubah/'.$value->id_artikel); ?>" class="btn btn-success btn-xs">Ubah</a>
                    				<a href="<?php echo base_url('artikel/hapus/'.$value->id_artikel.'/'.$value->gambar); ?>" class="btn btn-danger btn-xs">Hapus</a>
                            </div>
                          </td>
                    		</tr>
                    	</tbody>
