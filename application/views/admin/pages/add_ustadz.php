            ...
            <div class=" col-xlg-2 bg-white">
              <div class="col-md-12 m-b-10">
                <div class="card card-transparent">
                  ...
                  <form class="form-horizontal" method="post" action="<?php echo site_url('ustadz/save'); ?>">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <textarea placeholder="alamat" class="form-control" name="alamat" required><?php echo set_value('alamat');?></textarea>
                        <?= form_error('alamat'); ?>
                      </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                      <label class="control-label">Pendidikan</label>
                        <div class="controls">
                          <input type="text" placeholder="pendidikan" name="pendidikan" class="form-control" value="<?php echo set_value('pendidikan'); ?>">
                    ...
                    <div class="control-group">
                      <div class="controls">
                        ...
                        <a href="<?php echo site_url('admin/ustadz'); ?>" class="btn btn-danger">Kembali</a>
                      </div>
                    </div>
                  </form>
                  </div>
