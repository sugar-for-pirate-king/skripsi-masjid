                ...
                <div class="card card-transparent">
                  <div class="card-header">
                    <div class="card-title">
                      <h4>Tambah Daftar Ustadz</h4>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  <div class="card-block">
                  <form class="form-horizontal" method="post" action="<?php echo site_url('admin/ustadz/save'); ?>">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <input type="text" name="ttl" class="form-control" value="<?php echo set_value('ttl');?>" required>
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label">Alamat</label>
                      <div class="controls">
                        <textarea class="form-control" name="alamat" required><?php echo set_value('alamat');?></textarea>
                      </div>
                    </div>
                    <div class="control-group">
                      <label class="control-label">Nomor Handphone</label>
                      <div class="controls">
                        <input type="text" name="no_hp" class="form-control" value="<?php echo set_value('no_hp');?>" required>
                      </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                      <label class="control-label">Pendidikan</label>
                        <div class="controls">
                          <input type="text" name="pendidikan" class="form-control" value="<?php echo set_value('pendidikan'); ?>">
                        </div>
                    </div>
                    <br><br>
                    <div class="control-group">
                      <div class="controls">
                        ...
                        <a href="<?php echo site_url('ustadz'); ?>" class="btn btn-danger">Kembali</a>
                      </div>
                    </div>
                  </form>
                  </div>
