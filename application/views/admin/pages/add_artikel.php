            ...
            <div class=" col-xlg-2 bg-white">
              <div class="col-md-12 m-b-10">
                <div class="card card-transparent">
                  ...
                  <form class="form-horizontal" method="post" action="<?php echo site_url('artikel/save'); ?>" enctype="multipart/form-data">
                    <div class="control-group">
                      <label class="control-label" for="inputJudul">Judul</label>
                      <div class="controls">
                        <input type="text" placeholder="Judul Artikel" name="jdl_art" value="<?php echo set_value('jdl_art');?>" class="form-control" required>
                      </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <textarea rows="10" cols="60" placeholder="Isi artikel..." class="span12" name="isi_art" required><?php echo set_value('isi_art');?></textarea>
                      </div>
                    </div>
                    <div class="control-group">
