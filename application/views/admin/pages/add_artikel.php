            ...
            <div class=" col-xlg-2 bg-white">
              <div class="col-md-12 m-b-10">
                <div class="card card-transparent">
                  ...
                  <form class="form-horizontal" method="post" action="<?php echo site_url('admin/artikel/save'); ?>" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                      ...
                      <div class="controls">
                        <textarea rows="10" cols="60" class="span12" name="isi_art" required><?php echo set_value('isi_art');?></textarea>
                      </div>
                    </div>
                    <div class="control-group">
