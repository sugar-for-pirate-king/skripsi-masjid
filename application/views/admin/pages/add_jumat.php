            ...
            <div class=" col-xlg-2 bg-white">
              <div class="col-md-12 m-b-10">
                <div class="card card-transparent">
                  ...
                  <form class="form" method="post" action="<?php echo site_url('jumat/save'); ?>">
                    <div class="row">
                    <div class="col-lg-2">
                    <div class="form-group">   
                      <label class="">Tanggal</label>
                      <div class="input-group p-l-0">
                      <input type="text" placeholder="--/--/----" name="tanggal" value="<?php echo set_value('tanggal');?>" class="form-control" required><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                      <?= form_error('tanggal'); ?>
                    </div>
                    </div>
                    </div>
                    ...
                    <label>Jam</label>
                      <div class="input-group p-l-0">
                      <input type="text" placeholder="00:00" name="jam" value="<?php echo set_value('jam');?>" class="form-control" required>
                    ...
                    <div class="form-group">   
                      ...
                      <div class="input-group p-l-0">
                      <input type="text" placeholder="imam" name="imam" value="<?php echo set_value('imam');?>" class="form-control" required>
                      <?= form_error('imam'); ?>
                    </div>
                    </div>
                    </div>
                    ...
                    <div class="form-group">   
                      ...
                      <div class="input-group p-l-0">
                      <input type="text" placeholder="khatib" name="khatib" value="<?php echo set_value('khatib');?>" class="form-control" required>
                      <?= form_error('khatib'); ?>
                    </div>
                    </div>
                    </div>
                    ...
                    <div class="form-group">   
                      ...
                      <div class="input-group p-l-0">
                      <input type="text" placeholder="muadzin" name="muadzin" value="<?php echo set_value('muadzin');?>" class="form-control" required>
                      <?= form_error('muadzin'); ?>
                    </div>
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                      <div class="controls">
                        ...
                        <a href="<?php echo site_url('admin/jumat'); ?>" class="btn btn-danger">Kembali</a>
                      </div>
                    </div>
                  </form>
                  </div>
