                ...
                <div class="card card-transparent">
                  <div class="card-header">
                    <div class="card-title">
                      <h4>Ubah Laporan Infaq</h4>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  <div class="card-block">
                  <form class="form-horizontal" method="post" action="<?php echo site_url('admin/infaq/update'); ?>">
                    <input type="hidden" name="id_infaq" value="<?php echo $data_artikel->id_infaq; ?>">
                    <br>
                    ...
                    <div class="control-group col-lg-3">
                      <div class="controls">
                        ...
                        <a href="<?php echo site_url('infaq'); ?>" class="btn btn-danger">Kembali</a>
                      </div>
                    </div>
                  </form>
                  </div>
