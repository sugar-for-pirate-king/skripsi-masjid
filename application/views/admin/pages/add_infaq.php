            ...
            <div class=" col-xlg-2 bg-white">
              <div class="col-md-12 m-b-10">
                <div class="card card-transparent">
                  ...
                  <form class="form-horizontal" method="post" action="<?php echo site_url('admin/infaq/save'); ?>">
                    <br>
                    ...
                    <div class="control-group col-lg-4">   
                      ...
                      <input type="text" name="tanggal" class="form-control"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                    </div>
