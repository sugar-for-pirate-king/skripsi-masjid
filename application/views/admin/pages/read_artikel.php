              ...
              <div class="col-md-12 m-b-10">
                <div class="card card-transparent">
                  <div class="card-block">
                    <div class="row">                      
                      <div class="col-md-4">
                       <img class="img-responsive" src="<?php echo base_url('uploads/'.$data_artikel->gambar); ?>" alt="" style="width: 200px; height: 200px;">
                      </div>
                      <div class="col-md-2"></div>
                      <div class="row">
                        <div class="col-md-12"></div>
                        <div class="col-md-12">
                          <h3 class="semi-bold"><?php echo $data_artikel->judul; ?></h3>
                          <p>Kategori : <?php echo $data_artikel->kategori; ?></p>
                          <p><button href="#" class="btn btn-complete btn-cons btn-xs">Diposkan pada <?php echo $data_artikel->tanggal; ?> </button></p>
                        </div>
                      </div>
                    </div>
                    <br><br>
                      <div class="col-md-12">
                        <p style="text-align: justify;"><?php echo $data_artikel->isi; ?></p>
                      </div>
                  </div>
                </div>
              </div>
