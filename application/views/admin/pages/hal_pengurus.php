                ...
                <div class="card card-transparent">
                  <div class="card-header">
                    ...
                    <div class="pull-right">
                      <div class="col-xs-12">
                        <a href="<?php echo site_url('pengurus/tambah');?>" class="btn btn-complete btn-cons">Tambah Daftar</a>
                      </div>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                    ...
                    <table class="table demo-table-search table-responsive-block" id="tableWithSearch">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div class="btn-group">
                            <a href="<?php echo site_url('pengurus/ubah/'.$value->id_pengurus); ?>" class="btn btn-success btn-xs">Ubah</a>
                            <a href="<?php echo site_url('pengurus/hapus/'.$value->id_pengurus); ?>" class="btn btn-danger btn-xs">Hapus</a>
                            </div>
                          </td>
                        </tr>
                      </tbody>
