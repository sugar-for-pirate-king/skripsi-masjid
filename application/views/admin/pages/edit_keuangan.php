                ...
                <div class="card card-transparent">
                  <div class="card-header">
                    <div class="card-title">
                      <h4>Ubah Laporan Keuangan</h4>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                  <div class="card-block">
                  <?php echo validation_errors(); ?>
                  <form class="form-horizontal" method="post" action="<?php echo site_url('keuangan/update'); ?>">
                  <input type="hidden" name="id_keuangan" value="<?php echo $data_artikel->id_keuangan; ?>">
                    <br>
                    <div class="control-group col-lg-3">
                      <label class="control-label">Keterangan</label>
                      <input type="text" name="keterangan" value="<?php echo $data_artikel->keterangan;?>" class="form-control" required>
                      <?php echo form_error('keterangan'); ?>
                    </div>                    
                    <div class="control-group col-lg-3">   
                      <label class="control-label">Tanggal</label>
                      <div class="input-group p-l-0">
                      <input type="text" name="tanggal" value="<?php echo $data_artikel->tanggal; ?>" class="form-control"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                      </div>
                      <?php echo form_error('tanggal'); ?>
                    </div>                    
                    <div class="control-group col-lg-3">
                      <label class="control-label">Nominal</label>
                      <input type="text" name="nominal" value="<?php echo $data_artikel->nominal;?>" class="form-control" required>
