            ...
            <div class=" col-xlg-2 bg-white">
              <div class="col-md-12 m-b-10">
                <div class="card card-transparent">
                  ...
                  <div class="row">
                  <div class="col-lg-3">
                  <form class="form" method="post" action="<?php echo site_url('admin/keuangan/update'); ?>">
                  <input type="hidden" name="id_keuangan" value="<?php echo $data_artikel->id_keuangan; ?>">
                    ...
                    <div class="form-group">
                      <label>Aturan</label>
                      <select name="ket" class="form-control" required><span class="input-group-addon"><i class="fa fa-angle-down">
