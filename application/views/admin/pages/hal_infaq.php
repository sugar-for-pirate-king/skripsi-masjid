                ...
                <div class="card card-transparent">
                  <div class="card-header">
                    ...
                    <div class="pull-right">
                    	<div class="col-xs-12">
                    		<a href="<?php echo site_url('admin/infaq/tambah');?>" class="btn btn-complete btn-cons">Tambah Laporan</a>
                    	</div>
                    </div>
                    <div class="clearfix"></div>
                  </div>
                    ...
                    <table class="table demo-table-search table-responsive-block">
                    	...
                    	<tbody>
                          ...
                          <td><?php echo $value->nominal; ?></td>
                    			<td>
                            <div class="btn-group">
                    				<a href="<?php echo site_url('admin/infaq/ubah/'.$value->id_infaq); ?>" class="btn btn-success btn-xs">Ubah</a>
                            <a href="<?php echo site_url('admin/infaq/hapus/'.$value->id_infaq); ?>" class="btn btn-danger btn-xs">Hapus</a>
                            </div>
                          </td>
                    		</tr>
                    	</tbody>
