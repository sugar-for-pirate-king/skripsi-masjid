          ...
          <div class="bg-white">
            <div class="container">
              <ol class="breadcrumb breadcrumb-alt">
                ...
                <li class="breadcrumb-item active">Shalat</li>
              </ol>
            </div>
          </div>
          <!-- END BREADCRUMBS -->
            ...
            <div class=" col-xlg-12 bg-white">
              <div class="col-md-12 m-b-10">
                <div class="card card-transparent">
                  ...
                  <div class="">
                    <p class="text-center"><iframe src="https://www.jadwalsholat.org/adzan/monthly.php?id=67" height="750" width="430" frameborder="0"></iframe></p>
                  </div>
                </div>
              </div>
            </div>
