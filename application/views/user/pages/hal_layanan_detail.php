          ...
          <div class="bg-white">
            <div class="container">
              <ol class="breadcrumb breadcrumb-alt">
                ...
                <li class="breadcrumb-item"><a href="<?php echo site_url('layanan');?>">Layanan</a></li>
                <li class="breadcrumb-item active"><?php echo $detail_layanan->judul;?></li>
              </ol>
            </div>
          </div>
          <!-- END BREADCRUMBS -->
            ...
            <div class=" col-xlg-12 bg-white">
              <div class="col-md-12 m-b-10">
                ...
                <div class="card-block">
                  <div class="row">
                    <div class="col-md-4">
                      <img class="img-fluid" src="<?php echo base_url('uploads/'.$detail_layanan->gambar)?>" style="width: 250px; height: 150px;">
                    </div>
                    <div class="col-md-2"></div>
                    <div class="row">
                      <div class="col-md-12"></div>
                        <div class="col-md-12">
                          <h3 class="semi-bold"><?php echo $detail_layanan->judul;?></h3>
                          <p><button href="#" class="btn btn-danger">Diposkan pada <?php echo $detail_layanan->tanggal; ?> </button></p>
                        </div>
                    </div>
                  </div>
                  <br><br>
                    <div class="col-md-12">
                      <p style="text-align: justify;"><?php echo $detail_layanan->isi; ?></p>
                    </div>
                </div>
                </div>
              </div>
