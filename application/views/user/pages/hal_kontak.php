              ...
              <div class="col-md-12 m-b-10">
                <div class="card card-transparent">
                  ...
                  <div class="card-block">
                    <p class="fs-16 font-montserrat">Silahkan mengisi form dibawah ini jika ada perihal yang ingin ditanyakan.</p><br>
                    <form class="form-horizontal" method="post" action="<?php echo site_url('pesan/save'); ?>">
                    <div class="control-group col-md-5">
                      <label class="control-label">Nama</label>
                      <div class="controls">
                        <input type="text" placeholder="Nama anda...." name="nama" value="<?php echo set_value('nama');?>" class="form-control" required>
                      </div>
                    </div>
                    <div class="control-group col-md-5">
                      <label class="control-label">Email</label>
                      <div class="controls">
                        <input type="email" placeholder="Email anda...." name="email" value="<?php echo set_value('email');?>" class="form-control" required>
                      </div>
                    </div>
                    <div class="control-group col-md-5">
                      <label class="control-label">Website</label>
                      <div class="controls">
                        <input type="text" placeholder="Website anda...." name="website" value="<?php echo set_value('website');?>" class="form-control">
                      </div>
                    </div>
                    <div class="control-group col-md-5">
                      <label class="control-label">Pesan</label>
                      <div class="controls">
                        <textarea rows="10" cols="60" class="span12" placeholder="Isi pesan anda...." name="pesan" required><?php echo set_value('pesan');?></textarea>
                      </div>
                    </div>
                    <br>
                    <div class="control-group col-md-5">
