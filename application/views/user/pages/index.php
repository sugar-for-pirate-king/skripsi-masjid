        ...
        <div class="content sm-gutter">
          ...
          <div class="container sm-padding-10 p-t-20 p-l-0 p-r-0">
            ...
            <div class="row m-b-30">
              <div class="col-lg-6 sm-m-t-10 d-flex">
                <div class="card social-card share  full-width m-b-10 no-border" data-social="item">
                  <div class="card-description text-center">
                    <h4><span class="bold">Masjid Al-Hanif</span></h4>
                    <address class="font-montserrat">Kp. Sugutamu Jl. H. Solehan RT/RW 02/028 No.30 Kelurahan Baktijaya Kecamatan Sukmajaya Depok 16418</address>
                  </div>
                </div>
              </div>
              <div class="col-lg-6 sm-m-t-10 d-flex">
                <div class="card social-card share  full-width m-b-10 no-border" data-social="item">
                  <div class="card-description">
                    <h3 class="all-caps font-montserrat text-center">Pusat Informasi </h3>
                    <p class="text-center fs-16">089653197233</p>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 sm-m-t-10 d-flex">
                <div class="card social-card share  full-width m-b-10 no-border" data-social="item">
                  <div class="card-header ">
                    <a href="<?php echo site_url('agenda');?>"><p class="pull-left fs-16 font-montserrat">Agenda</p></a>
                  ...
                  ?>
                  <ul>
                    <a href="<?php echo site_url('agenda/'.$value->slug); ?>"><li><?php echo $value->judul; ?></li></a>
                  </ul>
                  <?php
                    }
                  ?>
              ...
              <div class="col-lg-4 sm-m-t-10 d-flex">
                <div class="card social-card share  full-width m-b-10 no-border" data-social="item">
                  <div class="card-header ">
                    <a href="<?php echo site_url('kajian');?>"><p class="pull-left fs-16 font-montserrat">Kajian</p></a>
                    <div class="clearfix"></div>
                  </div>
                  <div class="card-description">
                  <?php
                    foreach ($kajian as $value) 
                    {
                  ?>
                  <ul>
                    <a href="<?php echo site_url('kajian/'.$value->slug); ?>"><li><?php echo $value->judul; ?></li></a>
                  </ul>
                  <?php 
                    }
                  ?>
              ...
              <div class="col-lg-4 sm-m-t-10 d-flex">
                <div class="card social-card share  full-width m-b-10 no-border" data-social="item">
                  <div class="card-header ">
                    <a href="<?php echo site_url('pengumuman');?>"><p class="pull-left fs-16 font-montserrat">Pengumuman</p></a>
                    <div class="clearfix"></div>
                  </div>
                  <div class="card-description">
                  <?php
                  ...
                  ?>
                  <ul>
                    <a href="<?php echo site_url('pengumuman/'.$value->slug); ?>"><li><?php echo $value->judul; ?></li></a>
                  </ul>
                  <?php 
                    }
                  ?>
              ...
              <div class="col-lg-12 sm-m-t-10 d-flex">
                <div class="card social-card share  full-width m-b-10 no-border" data-social="item">
                  <div class="card-header ">
                    <a href="<?php echo site_url('infaq');?>"><p class="pull-left fs-16 font-montserrat">Laporan Infaq</p></a>
                  </div>
